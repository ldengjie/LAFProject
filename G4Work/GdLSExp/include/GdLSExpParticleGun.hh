...
//
//
// $Id: GdLSExpParticleGun.hh,v 1.11 2007/11/07 17:13:19 asaim Exp $
// GEANT4 tag $Name: geant4-09-02-beta-01 $
//

#ifndef GdLSExpParticleGun_h
#define GdLSExpParticleGun_h 1
...
// particle. But, GdLSExpParticleGun does NOT have any way of randomization. Instead, the user's
...
class GdLSExpParticleGun:public G4VPrimaryGenerator
{
  public: // with description
     GdLSExpParticleGun();
     GdLSExpParticleGun(G4int numberofparticles);
     GdLSExpParticleGun(G4ParticleDefinition * particleDef, 
  ...
  public:
     virtual ~GdLSExpParticleGun();

  private:
     GdLSExpParticleGun(const GdLSExpParticleGun&);
     const GdLSExpParticleGun & operator=(const GdLSExpParticleGun&);
     G4int operator==(const GdLSExpParticleGun&) const;
     G4int operator!=(const GdLSExpParticleGun&) const;
