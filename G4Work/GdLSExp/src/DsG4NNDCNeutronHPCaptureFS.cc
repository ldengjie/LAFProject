...
void DsG4NNDCNeutronHPCaptureFS::UpdateNucleus( const G4Fragment* gamma , G4double eGamma )
{
    ...
    // Geant4.9.4.p02, /home/dyb/dybsw/NuWa-64/external/geant4/geant4.9.4.p02/source/processes/hadronic/models/neutron_hp/src/G4NeutronHPCaptureFS.cc
    G4double m1 = G4ParticleTable::GetParticleTable()->FindIon(static_cast<G4int>(nucleus->GetZ()+0.5), static_cast<G4int>(nucleus->GetA()+0.5), 0, static_cast<G4int>(nucleus->GetZ()+0.5))->GetPDGMass();
