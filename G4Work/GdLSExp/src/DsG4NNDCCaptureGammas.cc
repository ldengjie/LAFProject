...
void DsG4NNDCCaptureGammas::Init( int A, int Z )
{
   ...
   //ifstream file("/afs/ihep.ac.cn/soft/dayabay/NuWa-64/daily/opt/release/NuWa-trunk/dybgaudi/Database/SimData/data/NeutronCaptureGammas.txt"); 
