...
GdLSExpAnalysisManagerMessenger::GdLSExpAnalysisManagerMessenger(GdLSExpAnalysisManager* manager)
:histo (manager)
{
...
GdLSExpAnalysisManagerMessenger::~GdLSExpAnalysisManagerMessenger()
{
  delete histoCmd;
  delete factoryCmd;
  delete histoDir;
...
void GdLSExpAnalysisManagerMessenger::SetNewValue(G4UIcommand* command,G4String newValues)
{
