...
void DsG4GdNeutronHPCaptureFS::UpdateNucleus( const G4Fragment* gamma , G4double eGamma )
{
    ...
    G4double m1 = G4ParticleTable::GetParticleTable()->FindIon(static_cast<G4int>(nucleus->GetZ()), static_cast<G4int>(nucleus->GetA()), 0, static_cast<G4int>(nucleus->GetZ()))->GetPDGMass();
