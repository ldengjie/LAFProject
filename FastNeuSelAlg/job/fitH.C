...
int fitPFHT2Mu2()
{
    ...
    RooRealVar mean("mean_mu","mean",20,15,25);
    RooRealVar sigma("sigma_mu","sigma",13,8,18);
    RooRealVar mean2("mean_fn","mean2",70,50,120);
    RooRealVar sigma2("sigma_fn","sigma2",25,25,50);
