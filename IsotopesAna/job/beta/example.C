{
    ...
    // // Initialize BetaSpec(string name, int Z, int A, int charge=-1, string dir=".", bool useHuber=false,double qmax=0.0)
    BetaSpec b("B12", 5, 12);
    ...
    BetaSpec b("He8", 2, 8,-1,".",0,10.652);// b.Qmax = 10.652;
    BetaSpec b("He8_beta_only", 2, 8,-1,".",0,10.652);// b.Qmax = 10.652;
    BetaSpec b("He8_beta_neutron", 2, 8);
    BetaSpec b("Li8", 3, 8);
    BetaSpec b("B8", 5, 8, 1);

    // BetaSpec b("C10", 6, 10, 1,".",0,.651);// b.Qmax = 2.651;
