void plotSpectra(){
  ...
  const TString strDirs[] = {"Muon20to60", "Muon60to500", "Muon500to1500", "Muon1500to2500", "Muon2500to3500", "Muon3500to4500", "Muon4500to5000"};
  const int nSlices = 8-1; //sizeof(eMuonMinArr)/sizeof(int);
...
void drawHist(TH1F* h){
  ...
  h->Draw();
  TString title = Form("plots/%s.png", h->GetName());
  c->Print(title, "png");
  delete c;
}
