...
// Wed Jul  4 04:52:48 2012 by ROOT version 5.26/00e
// from TTree IbdTree/IbdTree
// found on file: run23093_IBD.root
//////////////////////////////////////////////////////////
...
public :
   ...
   //TChain chain;
	...
	TString histname;
	TString canname;
	TH1F *pt2Rpc[4][3];//0 for whole , 1 for vetoed ,2 for remain
	TH1F *dt2Rpc[4][3];//0 for whole , 1 for vetoed ,2 for remain
	TH1F *pE[4][3];
	TH1F *dE[4][3];
	TH2F *pxy[4][3];
	TH2F *dxy[4][3];
   ...
   Float_t        promptT2Muon[8];
   Float_t        delayedT2Muon[8];
