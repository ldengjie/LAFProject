...
Bool_t LiHisto::Process(Long64_t entry)
{
   ...
   // The return value is currently not used.
    ...
    if( isLi==1 )
    {
        double timeInSlice1=1000.;//500-2500
        double timeInSlice2=1000.;//>2500
        double timeInSlice3=1000.;//>500

        timeInSlice1=timeInSlice1>promptT2Muon[10+1]?promptT2Muon[10+1]:timeInSlice1;
        timeInSlice1=timeInSlice1>promptT2Muon[10+2]?promptT2Muon[10+2]:timeInSlice1;
        timeInSlice2=timeInSlice1>promptT2Muon[10+3]?promptT2Muon[10+3]:timeInSlice2;
        timeInSlice2=timeInSlice1>promptT2Muon[10+4]?promptT2Muon[10+4]:timeInSlice2;
        timeInSlice2=timeInSlice1>promptT2Muon[10+5]?promptT2Muon[10+5]:timeInSlice2;
        timeInSlice3=timeInSlice1>timeInSlice2?timeInSlice2:timeInSlice1;
        ...
        //}
        t2lastshowermuon[4][0]->Fill(timeInSlice1);
        t2lastshowermuon[4][3]->Fill(timeInSlice2);
        //t2lastshowermuon[4][2]->Fill(timeInSlice3);
    }
