...
// Tue Aug  7 15:09:01 2012 by ROOT version 5.26/00e
...
class CalibStats : public TSelector {
public :
 ...
 //PerHeaderObject *Data_CalibStats;
   ...
   Float_t         ELast_ADCalibShower_pe;
   Float_t         ELast_ADShower_pe;
   Float_t         EarlyCharge;
   Float_t         Kurtosis;
   Float_t         LateCharge;
   Float_t         MainPeakRMS;
   ...
   Float_t         dtLast_ADCalibShower_ms;
   Float_t         dtLast_ADMuon_ms;
   Float_t         dtLast_ADShower_ms;
